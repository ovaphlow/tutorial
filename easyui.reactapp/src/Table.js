    ...
    return (
      <div>
        <DataGrid data={this.state.data}>
          ...
          <GridColumn field="listprice" title="List Price"></GridColumn>
          <GridColumn field="unitcost" title="Unit Cost"></GridColumn>
          <GridColumn field="attr" title="Attribute"></GridColumn>
